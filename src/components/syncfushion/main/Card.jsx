...
import { FaChartPie, FaCheck, FaWallet, FaViadeo, FaAudible, FaDribbble, FaRegSmileWink, FaTencentWeibo, FaMixcloud, FaCodepen } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 p-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
        ...
        >
          ...
          <div className="w-14 h-14 flex items-center justify-center bg-fuchsia-100 rounded-xl mb-4 
          group-hover:rotate-12 transition duration-300">
